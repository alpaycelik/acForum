...
<head>
    ...
    <link rel="stylesheet" href="/backend/assets/vendor/bootstrap-datepicker/css/datepicker3.css" />
...
<section class="body">
    ...
    <header class="header">
        <div class="logo-container">
            <a href="../" class="logo">
                <img src="/backend/assets/images/logo.png" height="35" alt="Porto Admin" />
            </a>
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="/backend/assets/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle" />
                                        </figure>
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="/backend/assets/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle" />
                                        </figure>
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="/backend/assets/images/!sample-user.jpg" alt="Joe Junior" class="img-circle" />
                                        </figure>
...
<script src="/backend/assets/vendor/magnific-popup/magnific-popup.js"></script>
