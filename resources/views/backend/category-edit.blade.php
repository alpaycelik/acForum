                ...
                <div class="panel-body">
                    <form class="form-horizontal form-bordered" method="post" id="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="inputDefault" name="title" value="{{ $category->title }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="textareaAutosize">Açıklama</label>
                            <div class="col-md-6">
                                <textarea class="form-control" rows="3" id="textareaAutosize" name="description" data-plugin-textarea-autosize>{{ $category->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
